          ...
          <div>
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <span className="font-semibold text-white">5-Step Deal Flow System</span>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-2xl">
            {status === "success" ? (
              <div className="text-center py-8">
                ...
                <p className="text-gray-600">Your Playbook is on its way. Redirecting you now...</p>
              </div>
            ) : (
              <>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div>
                    <label htmlFor="magnet-name" className="block text-sm font-medium text-gray-700 mb-1">
                      First Name
                    </label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label htmlFor="magnet-email" className="block text-sm font-medium text-gray-700 mb-1">
                      Email Address
                    </label>
                    <input
                      type="email"
                ...
                <div className="mt-6 pt-6 border-t border-gray-200">
                  <p className="text-sm text-gray-600 text-center">
                    ...
                    <a href="#application-form" className="text-blue-600 hover:underline font-medium">
                      Skip ahead and apply to see if you qualify →
                    </a>
                  </p>
                </div>
              </>
        ...
        <div className="mt-16 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="text-center">
              ...
              <h4 className="font-semibold text-white mb-2">Download the Playbook</h4>
              <p className="text-sm text-blue-200">
            ...
            <div className="text-center">
              ...
              <h4 className="font-semibold text-white mb-2">Apply If You Qualify</h4>
              <p className="text-sm text-blue-200">
                If you're closing deals and investing in marketing, apply to work with us.
              </p>
            </div>
            <div className="text-center">
              <div className="inline-flex items-center justify-center w-12 h-12 bg-white/20 rounded-full mb-4">
